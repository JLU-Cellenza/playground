...
module "storage_functions" {
  ...
  storage_account_name       = "stfnprd${var.project}01"
  location                   = var.location
  resource_group_name        = azurerm_resource_group.this.name
...
module "storage_logicapp_01" {
  ...
  storage_account_name       = "stlaprd${var.project}01"
  location                   = var.location
  resource_group_name        = azurerm_resource_group.this.name
  account_tier               = "Standard"
  replication_type           = "LRS"
...
module "storage_logicapp_02" {
  ...
  storage_account_name       = "stlaprd${var.project}02"
  location                   = var.location
  resource_group_name        = azurerm_resource_group.this.name
  account_tier               = "Standard"
  replication_type           = "LRS"
...
module "storage_platform" {
  ...
  storage_account_name       = "stplprd${var.project}01"
  location                   = var.location
  resource_group_name        = azurerm_resource_group.this.name
  account_tier               = "Standard"
  replication_type           = "LRS"
