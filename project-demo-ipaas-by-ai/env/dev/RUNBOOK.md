# Azure iPaaS Platform - Development Environment Runbook

## Overview

This runbook provides step-by-step instructions for deploying and managing the iPaaS platform in the development environment.
...
az group create `
  ...
  --tags project=mvp-ipaas environment=dev owner=cellenza created_by=terraform
```
...
# - Verify SKUs are cost-appropriate (Developer, Standard, Consumption)
...
Write-Host "Developer Portal: $(terraform output -raw apim_developer_portal_url)"
...
|---------|--------------|
| Function App | https://func-dev-cellenza-mvpipaas-helpers-01.azurewebsites.net |
| Logic App 01 | https://loa-dev-cellenza-mvpipaas-workflow-01.azurewebsites.net |
| Logic App 02 | https://loa-dev-cellenza-mvpipaas-workflow-02.azurewebsites.net |
| APIM Gateway | https://apim-dev-cellenza-mvpipaas-01.azure-api.net |
| APIM Portal | https://apim-dev-cellenza-mvpipaas-01.developer.azure-api.net |
| Service Bus | sb-dev-cellenza-mvpipaas-01.servicebus.windows.net |
| Platform Storage | https://stpldevcellenzamvpipaas01.blob.core.windows.net |
...
- **Solution**: Shorten project name in `dev.tfvars`
